...
export default function SettingsScreen() {
  ...
  const handlePrivacyPolicy = () => {
    void Linking.openURL("https://trilumos.github.io/trilumos-legal/");
  };

  const handleTermsOfService = () => {
    void Linking.openURL("https://trilumos.github.io/trilumos-legal/terms.html");
  };
  ...
  return (
    <SafeAreaView edges={["top", "left", "right"]} style={st.container}>
      ...
      >
        ...
        {/* Remove Ads — only shown when NOT premium */}
        {!isPremium && (
          <View style={st.card}>
            <TouchableOpacity
              style={st.settingsRow}
            ...
            >
              <View style={[st.iconCircle, { backgroundColor: theme.accentAlpha15 }]}>
                <Ionicons name="ban-outline" size={18} color={theme.accent} />
              </View>
              <View style={st.rowInfo}>
                <Text style={st.rowTitle}>Remove Ads</Text>
                <Text style={st.rowSub}>One-time purchase</Text>
              </View>
              <Ionicons name="chevron-forward" size={18} color={theme.textSecondary} />
            </TouchableOpacity>
          </View>
        ...
        <View style={st.card}>
          <View style={st.settingsRow}>
            <View style={st.iconCircle}>
              <Ionicons name="volume-high-outline" size={18} color={theme.textPrimary} />
            </View>
            <View style={st.rowInfo}>
            ...
            <Switch
              ...
              trackColor={{ false: theme.secondaryBg, true: theme.accent }}
              thumbColor={Platform.OS === "android" ? theme.textPrimary : undefined}
            />
          </View>
        </View>
        <View style={st.card}>
        ...
        <View style={st.card}>
          <View style={st.settingsRow}>
            <View style={st.iconCircle}>
              <Ionicons name="moon-outline" size={18} color={theme.textPrimary} />
            </View>
            <View style={st.rowInfo}>
